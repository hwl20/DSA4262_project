...
def main(valid_paths_csv, output_dir):
    ...
    lrs = [joblib.load(os.getcwd()+lr_path) for lr_path in lr_models_paths]
    ...
    for i in tqdm(range(0, len(npy_paths), 3)):
        ...
        # print("These are case_paths", case_paths)

...
def main(data_dir, models_dir):
    ...
    for condition in conditions:
        ...
        for plane in planes:
            checkpoint_pattern = glob(f'{models_dir}/{plane}/*_{plane}_{condition}*.pt')
            print("printing.......................")
            print(f'{models_dir}/{plane}/*_{plane}_{condition}*.pt')
            print(glob(f'{models_dir}/{plane}/*_{plane}_{condition}*.pt'))
